...
export default function ReminderSetupScreen() {
  ...
  const handleDone = async () => {
    ...
    if (enabledReminders.length === 0) {
      router.replace('/(onboarding)/personalizing' as any);
      return;
    }
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.innerContainer}>
        <View>
          ...
          <Text style={styles.headerSubtitle}>Choose when you'd like a gentle nudge. {'\n'} Your journaling routine is around the corner.</Text>
        </View>
