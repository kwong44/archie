...
// Gets the value from Expo config (app.json) and defaults to 'disabled' if not set
const AGENTIC_ANALYSIS = (Constants.expoConfig?.extra?.agenticAnalysis || 'disabled') as 'enabled' | 'disabled';

// Debug log the configuration
console.log('AI Client Configuration:', {
  agenticAnalysis: AGENTIC_ANALYSIS,
  aiBackendUrl: AI_BACKEND_URL
});
